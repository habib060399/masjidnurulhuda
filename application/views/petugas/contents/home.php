                ...
                <div class="col-md-3">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            ...
                            ?>
                            <h4> <?php //echo rupiah($row3['totaldana']); 
                                    ?></h4>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-md-3">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            ...
                            $query4 = "SELECT status, COUNT(*) AS tf FROM tbl_transfer WHERE `status` = 'tertunda'";
            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <div class="list-group">
                        <a href="<?php echo base_url() ?>petugas/cek_transfer" class="list-group-item">
                            <i class="icon-money"></i> Transfer menunggu konfirmasi
                            <span class="pull-right text-muted small"><em> <?php echo $row4['tf'];
                                                                            ?></em>
                            </span>
                        </a>
                        <a href="<?php echo base_url() ?>petugas/agenda" class="list-group-item">
                            <?php
                            ...
                            <span class="pull-right text-muted small"><em> <?php echo $row5['agenda'];
                                                                            ?></em>
                            </span>
                        </a>
                    </div>
