                 ...
                 <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapse2" class="body collapse in">
                                    <form class="form-horizontal" action="tambah_kategori" method="post" id="popup-validation">
										<div class="form-group">
											<label class="control-label col-lg-4">ID Kategori</label>
											<div class="col-lg-4">
												<input type="text" name="idkt" class="form-control chzn-select" tabindex="2" readonly="" value="<?php echo idkt();?>"/>
