    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div id="collapse2" class="body collapse in">
                <form class="form-horizontal" action="tambah_petugas" method="post" id="popup-validation">
                    <div class="form-group">
                        <label class="control-label col-lg-4">ID Petugas</label>
                        <div class="col-lg-4">
                            <input type="text" name="idpt" class="form-control chzn-select" tabindex="2" readonly="" value="<?php echo idpt(); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="no_hp" dat a-mask="+62 999 9999 9999" class="form-control" required />
                        </div>
                    </div>
